...
static const mico_i2c_device_t MFi_CP =
{
    .port = MICO_I2C_CP,
...
OSStatus PlatformMFiAuthInitialize( void )
{
    ...
    require_noerr_string(err, exit, "I2C driver initialize failed");

    require_string(MicoI2cProbeDevice( (mico_i2c_device_t *)&MFi_CP, 3 ), exit, "MFi CP chip probe failed");
