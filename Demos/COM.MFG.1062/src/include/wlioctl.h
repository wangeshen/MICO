...
#define WLC_IOCTL_MAXLEN        1536    /* max length ioctl buffer required */
...
#define WLC_LAST                318     /* XXX The last ioctl. Also push this
...
typedef struct {
	...
	uint32 rxmpdu_sgi;	/* non-ampdu frames with sgi */
	uint32 rxmpdu_stbc;  /* non-ampdu frames with stbc */
	uint32	rxmcs0_40M;  /* mpdu's recd at mc0 on 40MHz bw */
	uint32	rxmcs1_40M;  /* mpdu's recd at mc1 on 40MHz bw */
	uint32	rxmcs2_40M;  /* mpdu's recd at mc2 on 40MHz bw */
	uint32	rxmcs3_40M;  /* mpdu's recd at mc3 on 40MHz bw */
	uint32	rxmcs4_40M;  /* mpdu's recd at mc4 on 40MHz bw */
	uint32	rxmcs5_40M;  /* mpdu's recd at mc5 on 40MHz bw */
	uint32	rxmcs6_40M;  /* mpdu's recd at mc6 on 40MHz bw */
	uint32	rxmcs7_40M;  /* mpdu's recd at mc7 on 40MHz bw */

	uint32	txfrmsnt_20Mlo;  /* tx frames on 20MHz lower sideband in 40MHz operation */
	uint32	txfrmsnt_20Mup;  /* tx frames on 20MHz upper sideband in 40MHz operation */
	uint32	txfrmsnt_40M;   /* tx frames transmitted on 40MHz bw */
