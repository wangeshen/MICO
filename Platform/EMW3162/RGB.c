...
void OpenLED_RGB(float *color){
    MicoPwmInitialize( (mico_pwm_t)MICO_PWM_R, 50, 100 - (float)color[0]);
    MicoPwmStart( (mico_pwm_t)MICO_PWM_R);
    
    MicoPwmInitialize( (mico_pwm_t)MICO_PWM_G, 50, 100 - (float)color[1]);
    MicoPwmStart( (mico_pwm_t)MICO_PWM_G);
    
    MicoPwmInitialize( (mico_pwm_t)MICO_PWM_B, 50, 100 - (float)color[2]);
