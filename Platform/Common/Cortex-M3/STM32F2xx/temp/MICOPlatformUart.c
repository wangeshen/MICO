...
static OSStatus internal_uart_init ( wiced_uart_t uart, const wiced_uart_config_t* config, ring_buffer_t* optional_rx_buffer );
static OSStatus platform_uart_receive_bytes( wiced_uart_t uart, void* data, uint32_t size, uint32_t timeout );
...
OSStatus PlatformUartInitialize( wiced_uart_t uart, const wiced_uart_config_t* config, ring_buffer_t* optional_rx_buffer )
{
...
OSStatus PlatformStdioUartInitialize( const wiced_uart_config_t* config, ring_buffer_t* optional_rx_buffer )
{
    return internal_uart_init(STDIO_UART, config, optional_rx_buffer);
}


OSStatus internal_uart_init( wiced_uart_t uart, const wiced_uart_config_t* config, ring_buffer_t* optional_rx_buffer )
{
...
OSStatus PlatformUartFinalize( wiced_uart_t uart )
{
    NVIC_InitTypeDef nvic_init_structure;
...
OSStatus PlatformUartSend( wiced_uart_t uart, const void* data, uint32_t size )
{
...
OSStatus PlatformUartRecv( wiced_uart_t uart, void* data, uint32_t size, uint32_t timeout )
{
