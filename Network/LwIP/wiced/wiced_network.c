...
#else
    result = wiced_start_ap( (char*)"MXCHIP_TESTAP", WICED_SECURITY_WPA2_TKIP_PSK, "12345678", 1 );
#endif
...
#ifdef MXCHIPAPP
            delay_reload(); // DHCP can't get IP, reset...
#endif
            return WICED_ERROR;
        }
